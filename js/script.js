document.addEventListener('DOMContentLoaded', function () {
    ...
    /* =========================================================
       DROPDOWN "KUNJUNGI" -> DAFTAR AKUN (STATIS, HARDCODE DI PHP)
       Isi dropdown sudah dirender langsung oleh index.php,
       di sini hanya menangani buka/tutup menunya saja.
    ========================================================= */

    const dropdownToggles = document.querySelectorAll('.dropdown-sosmed-toggle');
    ...
    dropdownToggles.forEach(function (toggle) {
        toggle.addEventListener('click', function (event) {
            ...
            const dropdown = this.closest('.dropdown-sosmed');
            if (!dropdown) return;

            const isOpen = dropdown.classList.contains('open');

            document.querySelectorAll('.dropdown-sosmed.open').forEach(function (item) {
                item.classList.remove('open');
                const itemToggle = item.querySelector('.dropdown-sosmed-toggle');
                if (itemToggle) {
    ...
    document.addEventListener('click', function () {
        document.querySelectorAll('.dropdown-sosmed.open').forEach(function (dropdown) {
            dropdown.classList.remove('open');

            const toggle = dropdown.querySelector('.dropdown-sosmed-toggle');
            if (toggle) {
    ...
    if (cards.length && modal && canvas) {
        ...
        cards.forEach(function (card) {
            ...
            card.addEventListener('click', function (event) {
                ...
                // Tombol/dropdown "Kunjungi" tidak boleh membuka modal grafik.
                if (event.target.closest('.btn-kunjungi') ||
                    event.target.closest('.dropdown-sosmed')) {
                    return;
                }
